                ...
                <Carousel fade>
                    <Carousel.Item>
                            ...
                            <Row className="align-items-center home-slide"> 
                                ...
                                <Col xs lg="6">
                                <img className="slider-image mt-5 d-block w-100"  src={heroImg2} alt="First slide" />
                                </Col>
                            </Row>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item>
                        ...
                        <Carousel.Caption className="text-start">
                            <Row className="align-items-center home-slide"> 
                                ...
                                <Col xs lg="6">
                                <img className="slider-image mt-5 d-block w-100"  src={heroImg} alt="First slide" />
                                </Col>
                            </Row>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item>
                        ...
                        <Carousel.Caption className="text-start">
                            <Row className="align-items-center home-slide"> 
                                ...
                                <Col xs lg="6">
                                <img className="slider-image mt-5 d-block w-100"  src={heroImg1} alt="First slide" />
                                </Col>
                            </Row>
                        </Carousel.Caption>
                    </Carousel.Item>
